#ifndef _COLORER_STRINGWRITER_H_
#define _COLORER_STRINGWRITER_H_
...
public:
  ...
  */
    StringWriter(std::string& str, int encoding, bool useBOM);
  ~StringWriter();
  void write(wchar c);
protected:
    StringWriter();
  void init(std::string& str, int encoding, bool useBOM);
  void writeBOM();
  FILE *file;
  std::string* str;
private:
