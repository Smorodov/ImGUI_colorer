...
void ConsoleTools::genOutput(std::string& result, bool useTokens)
{
    result = "";
    try
    {
        ...
        try
        {
            ...
            else commonWriter = new StringWriter(result, outputEncodingIndex, bomOutput);
